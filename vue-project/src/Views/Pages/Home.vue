...
<div class="page-wrapper">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          ...
          >
            ...
            <br />
            <br />
            <span>Create an account to engage!</span> <br />Scroll down to view
            peoples posts!
          </p>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 bg-dark border border-dark">
    ...
    <h1 class="text-center fw-bold homefeed-mobile d-block d-sm-none">FEED</h1>
    ...
    <ul class="" style="list-style-type: none" v-if="posts.length">
      <li v-for="post in posts" :key="post.post_id">
        <router-link
          ...
          v-slot="{ navigate }"
        >
        <div @click="navigate" style="text-decoration: none; cursor: pointer">
          <p
